...
namespace _3DModel
{
    ...
    public partial class MainWindow : Window
    {
        ...
        public MainWindow()
        {
            ...
            Console.WriteLine(currentPosition.Z);
        ...
        private void edScale(object sender, KeyEventArgs e)
        {
            if(e.Key == Key.E || e.Key == Key.D)
            {
                ...
                zCenter = (zMax + zMin) / 2;
                Console.WriteLine("Z center is: " + zCenter);
                Console.WriteLine("Current position Z is " + currentPosition.Z);
                double vecZ;
                if(zCenter >= currentPosition.Z)
                {
                    vecZ = zCenter - currentPosition.Z;
                }
                else
                {
                    vecZ = zCenter;
                ...
                TranslateTransform3D trans = new TranslateTransform3D(currentPosition.X - centerPoint.X, currentPosition.Y - centerPoint.Y, zCenter - currentPosition.Z);
        ...
        private async Task writeData()
        {
            ...
            Console.WriteLine("3D Points Length: " + _3dPoints.Length);
            Console.WriteLine("Vectors length: " + normVectors.Length);
            Point3D tempPoint;
            Vector3D tempVec;
